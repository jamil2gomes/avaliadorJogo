...
const TermosDeUso = () => {
    ...
    return (
        ...
        <Container className="container">
           <h2>Termos de Uso</h2>
           <p>Ao se cadastrar na plataforma AutGamesFinder, você está concordando com esses Termos de Uso em sua integralidade.</p>
           <h3>Uso aceitável</h3>
           <p>O usuário declara que é o único responsável pelas avaliações e análises que vier a realizar nas 
            ...
            <p>O usuário se compromete a obedecer as seguintes regras:</p>
            <ul>
            ...
            <p><b>Utilizamos imagens de capa de jogo únicamente para prover informação visual 
